...
public class CategoryController {
    ...
    public ResponseEntity <List<CategoryDTO>> getCategoriesForCurrentProfile(){
        java.util.List<CategoryDTO> categories = categoryService.getCategoriesForCurrentProfile();
    ...
    public ResponseEntity<List<CategoryDTO>> updateCategoriesForCurrentProfile(@PathVariable Long categoryId, @RequestBody CategoryDTO categoryDTO){
        CategoryDTO updatedCategory = categoryService.updateCategory(categoryId, categoryDTO);
        return ResponseEntity.ok(List.of(updatedCategory));
    }
}
