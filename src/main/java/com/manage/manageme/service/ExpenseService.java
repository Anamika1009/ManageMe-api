...
public class ExpenseService {
    ...
    // helper method
    // this method is used to convert the ExpenseDTO to ExpenseEntity and set the profile and category
    ...
    // this method is used to convert the ExpenseEntity to ExpenseDTO and set the category name and category id
    ...
    private ExpenseDTO toDTO (ExpenseEntity expenseEntity) {
        return ExpenseDTO.builder()
                ...
                .categoryId(expenseEntity.getCategory()!= null? expenseEntity.getCategory().getId()
                        : null)
                .categoryName(expenseEntity.getCategory() != null? expenseEntity.getCategory().getName()
                        : "N/A")
                .build();
